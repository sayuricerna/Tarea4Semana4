...
namespace Tarea4Semana4.Controllers
{
    public class PagosController : Controller
    {
        ...
        public PagosController(ProfServicesDbContext context)
        {
            _context = context;
        }
        ...
        {
            var profServicesDbContext = _context.Pagos.Include(p => p.Reserva);
        ...
        public async Task<IActionResult> Create(Pago pago)
        {
            ...
            ViewData["ReservaId"] = new SelectList(_context.Reservas, "ReservaId", "FechaReserva", pago.ReservaId);
            return View(pago);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PagoId,ReservaId,Monto,MetodoPago,FechaPago,Estado,Comprobante,Descripcion,Factura,Comentario")] Pago pago)
        {
            if (id != pago.PagoId)
            {
                return NotFound();
